<div class="modal fade" id="create-role-modal" role="dialog" aria-hidden="true" style="display:none">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form id="create_role_form" method="post" action="" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="modal-footer">
         <button type="submit" class="btn btn-primary" id="create_role_submit">@lang('Submit')</button>
